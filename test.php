...
if(mysqli_num_rows($result)>0){
    ...
    while($row=mysqli_fetch_array($result, MYSQLI_ASSOC)){
        ...
        $date_time=$row['reg_date']." ".$row['reg_time'];
                                //echo $date_time;
        $closure_date=$row['reg_close'];

    }
}

?>
<div class="banner-info" id="countdown">
    <div class="dott">
        <div class="wrapper agileinfo">
            <h3 class="glow">Upcoming Registration</h3>
            <div class="clock">
                <div class="column w3l days">
                    <div class="timer w3" id="ndays"></div>
                    <div class="aits text">DAYS</div>
                </div>
                <div class="column w3">
                    <div class="timer w3layouts" id="nhours"></div>
                    <div class="agileits text">HOURS</div>
                </div>

                <div class="column wthree">
                    <div class="timer w3las" id="nminutes"></div>
                    <div class="text aits">MINUTES</div>
                </div>

                <div class="column siteliga">
                    <div class="timer stuoyal3w" id="nseconds"></div>
...
<?php
//echo $closure_date;
$reg_close=$closure_date." "."23:59:00" ;
...
<div class="agile_about contact" id="contact">
    ...
    <div class="agileits_agile_contact_form">
        <h3>Registration</h3> 
        <h4 style="margin-left: 35%" id="reqistration_close" style="font-size:1em"></h4>
        <br>
...
<!-- map -->
<div class="map">
    <iframe src="https://maps.google.com/maps?q=dhanmondi%2C%20dhaka%20bangladesh&t=&z=13&ie=UTF8&iwloc=&output=embed"></iframe>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 w3-footer-copy">
                                        <div class="copyright">
                                            <p>&copy; <?php echo date('Y');?> Goal. All Rights Reserved</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
var countdownfunction = setInterval(function() {
    ...
    document.getElementById("ndays").innerHTML = days;
    document.getElementById("nhours").innerHTML = hours;
    document.getElementById("nminutes").innerHTML = minutes;
    document.getElementById("nseconds").innerHTML = seconds;
 ...
 <script>
// Set the date we're counting down to
var countDownDateR = new Date("<?php echo $reg_close;?>").getTime();
//var countDownDate = new Date("Jan 5, 2019 15:37:25").getTime();

// Update the count down every 1 second
var countdownfunctionR = setInterval(function() {
    ...
    // Time calculations for days, hours, minutes and seconds
    var days1 = Math.floor(distanceR / (1000 * 60 * 60 * 24));
    var hours1 = Math.floor((distanceR % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
    var minutes1 = Math.floor((distanceR % (1000 * 60 * 60)) / (1000 * 60));
    var seconds1 = Math.floor((distanceR % (1000 * 60)) / 1000);
    
    //Output the result in an element with id="demo"
    document.getElementById("reqistration_close").innerHTML ="Closure Date: "+ days1 + "Days " + hours1 + "Hours "
